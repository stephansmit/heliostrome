...
final_df['init WC - Value'] = 'SAT'
writer = pd.ExcelWriter(r'heliostrome\jip_project\results\sensitivity_Morocco_InitialWaterContent.xlsx', engine = 'openpyxl', mode='a')
final_input_df.to_excel(writer, index=False, sheet_name= "SAT_Input Parameters")
final_df.to_excel(writer, index=False, sheet_name= "SAT_Output Results")
