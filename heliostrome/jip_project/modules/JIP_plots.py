...
def plot_season_data(input_path_waterflux, input_path_precip, sheet_name, start_date):
    ...
    ax1.bar(X_axis - 0.2, weekly_waterflux['IrrDay'], 0.4, label='Irrigation', color='blue')
    ax1.bar(X_axis + 0.2, weekly_precip['precip_mm'], 0.4, label='Precipitation', color='orange')
