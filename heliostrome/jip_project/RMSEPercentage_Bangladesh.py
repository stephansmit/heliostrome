...
# Read the Excel file
input_file_path = r"heliostrome\jip_project\results\test_results_Bangladesh.xlsx"
output_file_path = r"heliostrome\jip_project\results\RMSE_Percentage_Bangladesh.xlsx"
...
for case_study in case_studies:
    ...
    actual_water_use = matched_data.loc[
        matched_data["Case Study"] == case_study, "Water Used (mm)"
    ]
    simulation_water_use = matched_data.loc[
        matched_data["Case Study"] == case_study, "Seasonal irrigation (mm)"
    ]
