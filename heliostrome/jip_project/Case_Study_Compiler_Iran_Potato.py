...
CaseStudy_sheet = (
    "Iran Potato Case Study"  # Replace with the name of the sheet containing the data
)
...
writer1 = pd.ExcelWriter(
    r"heliostrome\jip_project\results\WaterFlux_IranPotato.xlsx", engine="openpyxl"
)
...
writer = pd.ExcelWriter(
    r"heliostrome\jip_project\results\test_results_IranPotato.xlsx", engine="openpyxl"
)
