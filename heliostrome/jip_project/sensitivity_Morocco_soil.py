...
writer = pd.ExcelWriter(
    r"heliostrome\jip_project\results\sensitivity_Morocco_soil.xlsx", engine="openpyxl"
)
...
for soil_type in soil_types:
    ...
    for i in range(len(extracted_rows["Case Study"])):
        ...
        print(
            f"Iteration {i+1} (Soil Type: {soil_type}): Sowing Date = {sowing_date}, Start Date = {start_date}, End Date = {end_date}"
        )
        start_time = end_time
