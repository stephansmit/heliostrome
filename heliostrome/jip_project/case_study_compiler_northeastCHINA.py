...
writer1 = pd.ExcelWriter(
    r"heliostrome\jip_project\results\WaterFlux_northeastCHINA.xlsx", engine="openpyxl"
)
...
writer = pd.ExcelWriter(
    r"heliostrome\jip_project\results\test_results_northeastCHINA.xlsx",
    engine="openpyxl",
)
...
output_path_analyse = (
    r"heliostrome/jip_project/results/analysed_WaterFlux_NorthEastCHINA.xlsx"
)
clean_excel_file(
