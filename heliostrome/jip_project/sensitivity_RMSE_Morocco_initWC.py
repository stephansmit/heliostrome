...
# 定义输入和输出文件的路径
input_file_path = r"heliostrome\jip_project\results\sensitivity_Morocco_initWC.xlsx"
output_file_path = (
    r"heliostrome\jip_project\results\sensitivity_RMSE_Morocco_initWC.xlsx"
)
...
input_sheet_names = [
    f"{WCvalue_type}_Input_Parameters" for WCvalue_type in WCvalue_types
]
output_sheet_names = [
    f"{WCvalue_type}_Output_Results" for WCvalue_type in WCvalue_types
]
