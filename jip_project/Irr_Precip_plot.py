...
#Example
#morocco wheat, case_study variation= validation field 5. Means sheet_name is V5 but for start date, its index=7
start_date = factors_to_run(FTR_sheets[0])["Start Date"][7]
